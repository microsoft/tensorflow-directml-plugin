...
class RNNGradTest(test.TestCase):
    ...
    def testLSTMBlockCell(self):
        ...
        self.assertAllClose(grads[0], grads[1], atol=1e-3)
    ...
    def testGRUBlockCell(self):
        ...
        w_ru = deterministic_random_uniform([input_size + cell_size, 2 * cell_size])
        w_c = deterministic_random_uniform([input_size + cell_size, cell_size])
