...
Status ResourceMgr::InsertDebugTypeName(uint64_t hash_code,
...
Status ResourceMgr::DoDelete(const std::string& container,
...
Status ResourceMgr::DoDelete(const std::string& container, std::type_index type,
                             const std::string& resource_name) {
...
Status ResourceMgr::DoLookup(const std::string& container, std::type_index type,
...
Status ResourceMgr::DoCreate(const std::string& container, std::type_index type,
