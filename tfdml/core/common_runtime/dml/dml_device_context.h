...
class DMLDeviceContext {
 ...
 public:
  ...
  Status CopyCPUTensorToDevice(DmlDevice* device, const Tensor* cpu_tensor,
                               Tensor* device_tensor) const;

  void CopyTensorInSameDevice(DmlDevice* device, const Tensor* input_tensor,
                              Tensor* output_tensor) const;

  Status CopyDeviceTensorToCPU(DmlDevice* device, const Tensor* device_tensor,
                               Tensor* cpu_tensor);

  Status CopyCPUMemoryToDevice(DmlDevice* device, const void* cpu_memory,
  ...
  void CopyMemoryInSameDevice(DmlDevice* device,
  ...
  // pool.
  DmlBuffer AllocateDefaultBuffer(OpKernelContext* op_kernel_context,
