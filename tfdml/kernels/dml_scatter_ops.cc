...
using ScatterAddKernel = typename KernelDefinition<
    ops::ScatterAdd,
    DmlKernelWrapper<
        DmlScatterUpdateKernel<Index, ScatterPlusOp<DataType>>,
        GetOutputShapeAsInputShapeHelper>>::
    template WithTypeConstraint<
        ops::ScatterAdd::Attribute::Tindices,
        DataTypeToEnum<Index>()>::
        template WithTypeConstraint<
            ops::ScatterAdd::Attribute::T,
            DataTypeToEnum<DataType>()>;

static void RegisterScatterAdd()
{
    ScatterAddKernel<int32_t, float>::Register();
    ScatterAddKernel<int64_t, float>::Register();
    ScatterAddKernel<int32_t, Eigen::half>::Register();
    ScatterAddKernel<int64_t, Eigen::half>::Register();
}

template <typename Index, typename DataType>
using ScatterSubKernel = typename KernelDefinition<
    ops::ScatterSub,
    DmlKernelWrapper<
        DmlScatterUpdateKernel<Index, ScatterMinusOp<DataType>>,
        GetOutputShapeAsInputShapeHelper>>::
    template WithTypeConstraint<
        ops::ScatterSub::Attribute::Tindices,
        DataTypeToEnum<Index>()>::
        template WithTypeConstraint<
            ops::ScatterSub::Attribute::T,
            DataTypeToEnum<DataType>()>;

static void RegisterScatterSub()
{
    ScatterSubKernel<int32_t, float>::Register();
    ScatterSubKernel<int64_t, float>::Register();
    ScatterSubKernel<int32_t, Eigen::half>::Register();
    ScatterSubKernel<int64_t, Eigen::half>::Register();
}

template <typename Index, typename DataType>
using ScatterMulKernel = typename KernelDefinition<
    ops::ScatterMul,
    DmlKernelWrapper<
        DmlScatterUpdateKernel<Index, ScatterMulOp<DataType>>,
        GetOutputShapeAsInputShapeHelper>>::
    template WithTypeConstraint<
        ops::ScatterMul::Attribute::Tindices,
        DataTypeToEnum<Index>()>::
        template WithTypeConstraint<
            ops::ScatterMul::Attribute::T,
            DataTypeToEnum<DataType>()>;

static void RegisterScatterMul()
{
    ScatterMulKernel<int32_t, float>::Register();
    ScatterMulKernel<int64_t, float>::Register();
    ScatterMulKernel<int32_t, Eigen::half>::Register();
    ScatterMulKernel<int64_t, Eigen::half>::Register();
}

template <typename Index, typename DataType>
using ScatterDivKernel = typename KernelDefinition<
    ops::ScatterDiv,
    DmlKernelWrapper<
        DmlScatterUpdateKernel<Index, ScatterDivOp<DataType>>,
        GetOutputShapeAsInputShapeHelper>>::
    template WithTypeConstraint<
        ops::ScatterDiv::Attribute::Tindices,
        DataTypeToEnum<Index>()>::
        template WithTypeConstraint<
            ops::ScatterDiv::Attribute::T,
            DataTypeToEnum<DataType>()>;

static void RegisterScatterDiv()
{
    ScatterDivKernel<int32_t, float>::Register();
    ScatterDivKernel<int64_t, float>::Register();
    ScatterDivKernel<int32_t, Eigen::half>::Register();
    ScatterDivKernel<int64_t, Eigen::half>::Register();
}

template <typename Index, typename DataType>
using ScatterMinKernel = typename KernelDefinition<
    ops::ScatterMin,
    DmlKernelWrapper<
        DmlScatterUpdateKernel<Index, ScatterMinOp<DataType>>,
        GetOutputShapeAsInputShapeHelper>>::
    template WithTypeConstraint<
        ops::ScatterMin::Attribute::Tindices,
        DataTypeToEnum<Index>()>::
        template WithTypeConstraint<
            ops::ScatterMin::Attribute::T,
            DataTypeToEnum<DataType>()>;

static void RegisterScatterMin()
{
    ScatterMinKernel<int32_t, float>::Register();
    ScatterMinKernel<int64_t, float>::Register();
    ScatterMinKernel<int32_t, Eigen::half>::Register();
    ScatterMinKernel<int64_t, Eigen::half>::Register();
}

template <typename Index, typename DataType>
using ScatterMaxKernel = typename KernelDefinition<
    ops::ScatterMax,
    DmlKernelWrapper<
        DmlScatterUpdateKernel<Index, ScatterMaxOp<DataType>>,
        GetOutputShapeAsInputShapeHelper>>::
    template WithTypeConstraint<
        ops::ScatterMax::Attribute::Tindices,
        DataTypeToEnum<Index>()>::
        template WithTypeConstraint<
            ops::ScatterMax::Attribute::T,
            DataTypeToEnum<DataType>()>;

static void RegisterScatterMax()
{
    ScatterMaxKernel<int32_t, float>::Register();
    ScatterMaxKernel<int64_t, float>::Register();
    ScatterMaxKernel<int32_t, Eigen::half>::Register();
    ScatterMaxKernel<int64_t, Eigen::half>::Register();
}

template <typename Index, typename DataType>
using ScatterUpdateKernel = typename KernelDefinition<
    ops::ScatterUpdate,
    DmlKernelWrapper<
        DmlScatterUpdateKernel<Index, ScatterUpdateOperation>,
        GetOutputShapeAsInputShapeHelper>>::
    template WithTypeConstraint<
        ops::ScatterUpdate::Attribute::Tindices,
        DataTypeToEnum<Index>()>::
        template WithTypeConstraint<
            ops::ScatterUpdate::Attribute::T,
            DataTypeToEnum<DataType>()>;

static void RegisterScatterUpdate()
{
    ScatterUpdateKernel<int32_t, float>::Register();
    ScatterUpdateKernel<int64_t, float>::Register();
    ScatterUpdateKernel<int32_t, Eigen::half>::Register();
    ScatterUpdateKernel<int64_t, Eigen::half>::Register();
}
