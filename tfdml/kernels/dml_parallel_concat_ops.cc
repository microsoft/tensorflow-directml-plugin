...
static void RegisterParallelConcatStart()
{
    ...
    RegisterWithTypes<K, ops::_ParallelConcatStart::Attribute::dtype, TF_FLOAT, TF_HALF>();
}
...
static void RegisterParallelConcatUpdate()
{
    ...
    RegisterWithTypes<K, ops::_ParallelConcatUpdate::Attribute::T, TF_FLOAT, TF_HALF>();
}
