...
class DmlSoftmaxXentWithLogitsInitHelper : public InitializationHelper
{
  public:
    ...
    DmlSoftmaxXentWithLogitsInitHelper(
        OpKernelContext* ctx,
        std::shared_ptr<const Attributes> attr)
    {
        ...
        BCast bcast(
            BCast::FromShape(logits_in.shape()),
        ...
        OP_REQUIRES(
            ctx,
            TensorShapeUtils::IsMatrix(shape_in_),
...
class SoftmaxXentWithLogitsShapeHelper : public ShapeHelper
{
  public:
    ...
    {
        auto init_helper =
            static_cast<const DmlSoftmaxXentWithLogitsInitHelper*>(
  ...
  public:
        ...
        const InitHelper* init_helper)
    {
        ...
        dml::TensorDesc::Dimensions input_sizes = {
            1,
            1,
            static_cast<uint32_t>(shape_in.dim_size(0)),
        ...
        toBCastBatchDim =
            labels_shape.dim_size(0) == shape_in.dim_size(0) ? 0 : 1;
        toBCastClassDim =
            labels_shape.dim_size(1) == shape_in.dim_size(1) ? 0 : 1;
        ...
        // backprop: output tensor for the backprop, dims: batch_size,
        // num_classes.
...
void RegisterKernels_Xent()
{
    using K = KernelDefinition<
        ops::SoftmaxCrossEntropyWithLogits,
        DmlKernelWrapper<
            DmlSoftmaxXentWithLogitsKernel,
            SoftmaxXentWithLogitsShapeHelper>>;

    RegisterWithTypes<
        K,
        ops::SoftmaxCrossEntropyWithLogits::Attribute::T,
        TF_FLOAT,
        TF_HALF>();
}
} // namespace tfdml