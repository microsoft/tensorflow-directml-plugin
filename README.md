...
TensorFlow DirectML Plugin only works with the `tensorflow-cpu>=2.11` package, not `tensorflow` or `tensorflow-gpu`. To install the package, run the following commands:
